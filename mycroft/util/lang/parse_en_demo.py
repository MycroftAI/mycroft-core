...
def extract_datetime_en(string, dateNow, default_time):
    ...
    for idx, word in enumerate(words):
        ...
        # parse in a second
            ...
            if ':' in word:
                ...
                print (" hour, remainder before checking am/pm is : ",strHH + ',' + remainder)
                print (" wordnext, wordNextNext : ", wordNext + ',' + wordNextNext)
                if remainder == "":
    ...
    if hrAbs != -1 and minAbs != -1:
        ...
        if hrAbs is None and minAbs is None and default_time is not None:
            ...
            minAbs = minAbs or 0
        print("extractedDate : ", extractedDate)
        print("hrAbs, minAbs : ", str(hrAbs) + ',' + str(minAbs))
...
date2 = datetime(2017, 6, 27, 7, 4)
#date2= datetime.now()
rest = extract_datetime_en("set an alarm for tonight 10:30", date2, date2)
print(rest)