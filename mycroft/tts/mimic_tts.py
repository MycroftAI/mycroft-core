...
class Mimic(TTS):
    ...
    def get_tts(self, sentence, wav_file):
        ...
        audio_path = os.path.abspath('mycroft/tts/audio_config.txt')
        file_audio_config = open(audio_path, 'r')
        audio_config = eval(file_audio_config.read())
        file_audio_config.close()
        # Adds the SSML tags with current rate to the sentence
        rate = audio_config["rate"]
        sentence = "<speak><prosody rate=" + rate + ">" + sentence
        sentence += "</prosody></speak>"
