...
try:
    ...
    if sys.version_info[0] < 3:
        LOG.error("install python-mpv with pip install  "
                  "git+https://github.com/harry159821/python-mpv@py2compat")
    else:
        LOG.error("install python-mpv with pip install python-mpv")
    raise
