...
class AdaptService:
    ...
    def register_vocab(self, start_concept,
                       end_concept, alias_of, regex_str, lang):
        """Register vocabulary."""
    ...
    def _detach_skill_regexes(self, skill_id):
        ...
        for lang in self.supported_langs:
            self.engines[lang].drop_regex_entity(
                match_func=match_skill_regexes)
    ...
    def detach_intent(self, intent_name):
        ...
        for lang in self.supported_langs:
            new_parsers = [p
                           for p in self.engines[lang].intent_parsers
