...
frequently.  To improve performance, the MSM instance is memoized (cached).
"""
...
from mycroft.util.memoize import memoized
...
def build_msm_config(device_config: dict) -> MsmConfig:
    ...
    Rationale is that the create_msm function is memoized.  The memoization
...
def create_msm(msm_config: MsmConfig) -> MycroftSkillsManager:
    ...
    This function is memoized because it can take as long as 15 seconds to
