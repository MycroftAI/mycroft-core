...
class TestTTS(unittest.TestCase):
    def test_execute(self, mock_playback_thread):
        ...
        tts.get_tts.assert_called_with(
            "Oh no, not again", "/tmp/dummy/8da7f22aeb16bc3846ad07b644d59359.wav"
        )
        tts.queue.put.assert_called_with(("wav", mock_audio, mock_viseme, 42, False))
    ...
    def test_ssml_support(self, _):
        sentence = (
            "<speak>Prosody can be used to change the way words "
        ...
        sentence_no_ssml = (
            "Prosody can be used to change the way "
