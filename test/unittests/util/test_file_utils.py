...
from os.path import abspath, dirname, expanduser, join, normpath, isdir, exists
import shutil
import tempfile
...
class TestResolveResource(TestCase):
    ...
    def test_dot_mycroft(self, mock_isfile, mock_conf):
        ...
        self.assertEqual(
            resolve_resource_file("1984.txt"), expanduser("~/.mycroft/1984.txt")
        )
    ...
    def test_data_dir(self, mock_isfile, mock_conf):
        ...
        self.assertEqual(
            resolve_resource_file("1984.txt"),
    ...
    def test_source_package(self, mock_conf):
        ...
        mock_conf.get.return_value = test_config
        expected_path = join(
            MYCROFT_ROOT_PATH, "mycroft", "res", "text", "en-us", "and.word"
        )
