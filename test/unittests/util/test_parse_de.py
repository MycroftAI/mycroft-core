...
class TestNormalize(unittest.TestCase):
    ...
    def test_extractnumber(self):
        ...
        self.assertEqual(extractnumber("dies ist der erste Test", lang="de-de"), 1)
        self.assertEqual(extractnumber("dies ist 2 Test", lang="de-de"), 2)
        self.assertEqual(extractnumber("dies ist zweiter Test", lang="de-de"), 2)
        self.assertEqual(extractnumber("dies ist der dritte Test", lang="de-de"), 3)
        self.assertEqual(extractnumber("dies ist der Test Nummer 4", lang="de-de"), 4)
        self.assertEqual(extractnumber("ein drittel einer Tasse", lang="de-de"), 1.0 / 3.0)
        self.assertEqual(extractnumber("drei Tassen", lang="de-de"), 3)
        self.assertEqual(extractnumber("1/3 Tasse", lang="de-de"), 1.0 / 3.0)
        self.assertEqual(extractnumber("eine viertel Tasse", lang="de-de"), 0.25)
        ...
        self.assertEqual(extractnumber("1 Tasse und eine halbe", lang="de-de"), 1.5)
        self.assertEqual(extractnumber("eine Tasse und eine halbe", lang="de-de"), 1.5)
        self.assertEqual(extractnumber("eine und eine halbe Tasse", lang="de-de"), 1.5)
        self.assertEqual(extractnumber("ein und ein halb Tassen", lang="de-de"), 1.5)
        self.assertEqual(extractnumber("drei Viertel Tasse", lang="de-de"), 3.0 / 4.0)
        self.assertEqual(extractnumber("drei Viertel Tassen", lang="de-de"), 3.0 / 4.0)
    ...
    def test_numbers(self):
        self.assertEqual(normalize("dies ist eins zwei drei test", lang="de-de"),
                         "dies ist 1 2 3 test")
        self.assertEqual(normalize(u"es ist vier fünf sechs test", lang="de-de"),
                         "es ist 4 5 6 test")
        self.assertEqual(normalize("es ist sieben acht neun test", lang="de-de"),
                         "es ist 7 8 9 test")
        self.assertEqual(normalize("es ist sieben acht neun test", lang="de-de"),
                         "es ist 7 8 9 test")
        self.assertEqual(normalize(u"dies ist zehn elf zwölf test", lang="de-de"),
                         "dies ist 10 11 12 test")
        self.assertEqual(normalize("dies ist dreizehn vierzehn test", lang="de-de"),
                         "dies ist 13 14 test")
        self.assertEqual(normalize(u"dies ist fünfzehn sechzehn siebzehn", lang="de-de"),
                         "dies ist 15 16 17")
        self.assertEqual(normalize("dies ist achtzehn neunzehn zwanzig", lang="de-de"),
                         "dies ist 18 19 20")
