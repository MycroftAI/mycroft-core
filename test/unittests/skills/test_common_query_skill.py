...
class TestCommonQuerySkill(TestCase):
    ...
    def test_common_test_skill_action(self):
        ...
        query_action(
            Message(
                "query:action",
                data={"phrase": "What's the meaning of life", "skill_id": "asdf"},
            )
        )
        ...
        query_action(
            Message(
                "query:action",
                data={"phrase": "What's the meaning of life", "skill_id": "CQSTest"},
            )
        )
...
class TestCommonQueryMatching(TestCase):
    ...
    def test_failing_match_query_phrase(self):
        ...
        self.query_phrase(
            Message("question:query", data={"phrase": "What's the meaning of life"})
        )
